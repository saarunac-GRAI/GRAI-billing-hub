  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 w-full max-w-sm p-8 text-center">
        ...
        <h1 className="text-xl font-bold text-gray-900 mb-1">Billing Hub</h1>
        <p className="text-sm text-gray-500 mb-8">Centralized subscription tracking for all GRAI projects</p>
